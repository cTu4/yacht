...
<div class="search margin_center d-flex justify-content-center flex-column">
    ...
    <span class="t-32px font-weight-600" {if $toggle}style="display: none"{/if}>The ideal boat will be found anywhere in the world.<br/>
    Choose the country where you want to go on a maritime journey.</span>

    <form action="{""|fn_url}" name="search_form" method="get" {if $toggle}style="display: none"{/if}>
    ...
    <div class="search_buttons justify-content-between" {if !$toggle}style="display: flex!important;"{/if}>
