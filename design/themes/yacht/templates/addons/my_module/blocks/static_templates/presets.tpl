...
{assign var="feature_realise" value=""|get_release_filter}
{assign var="feature_berths" value=""|get_berths_filter}
...
<div class="presets  d-flex justify-content-between">
    ...
    <a class="item_preset t-18px font-weight-600 cm-submit" data-ca-target-form="release" data-ca-dispatch="dispatch[products.search]">
        {__('boats')} 2020
        <form name="release" method="get" class="hidden" action="{$config.http_location}">
{*            <input type="hidden" name="match" value="all" />*}
{*            <input type="hidden" name="subcats" value="Y" />*}
{*            <input type="hidden" name="pcode_from_q" value="Y" />*}
{*            <input type="hidden" name="pshort" value="Y" />*}
...
{*            <input type="hidden" name="pkeywords" value="Y" />*}
            <input type="hidden" name="search_performed" value="Y" />
            <input type="hidden" name="items_per_page" value="{$settings.Appearance.products_per_page}" />
            <input type="hidden" name="feature_variants[{$feature_realise}][]" value="2020" />
            <input type="hidden" name="feature_variants[{$feature_realise}][]" value="2020" />
        </form>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.9092 1.79081C12.9636 2.84521 12.9636 4.55474 11.9092 5.60915C10.8548 6.66355 9.14526 6.66355 8.09085 5.60915C7.03645 4.55474 7.03645 2.84521 8.09085 1.79081C9.14526 0.736398 10.8548 0.736398 11.9092 1.79081" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <a class="cm-submit item_preset t-18px font-weight-600" data-ca-target-form="berths" data-ca-dispatch="dispatch[products.search]">
        {__('boats')}<br> {__('with')} 3 {__('beths')}
        <form name="berths" method="get" class="hidden" action="{$config.http_location}">
            {*            <input type="hidden" name="match" value="all" />*}
            {*            <input type="hidden" name="subcats" value="Y" />*}
            {*            <input type="hidden" name="pcode_from_q" value="Y" />*}
            {*            <input type="hidden" name="pshort" value="Y" />*}
            ...
            <input type="hidden" name="search_performed" value="Y" />
            <input type="hidden" name="items_per_page" value="{$settings.Appearance.products_per_page}" />
            <input type="hidden" name="feature_variants[{$feature_berths}][]" value="3" />
            <input type="hidden" name="feature_variants[{$feature_berths}][]" value="3" />
        </form>
        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M11.9092 1.79081C12.9636 2.84521 12.9636 4.55474 11.9092 5.60915C10.8548 6.66355 9.14526 6.66355 8.09085 5.60915C7.03645 4.55474 7.03645 2.84521 8.09085 1.79081C9.14526 0.736398 10.8548 0.736398 11.9092 1.79081" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
