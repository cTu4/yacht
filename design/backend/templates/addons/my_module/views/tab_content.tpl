...
<div id="content_reservation" class="hidden">
    {foreach from=$reservations item="reservation" name="for_reserv"}
        ...
        <div id="item-{$smarty.foreach.for_reserv.iteration}">
            ...
            {include file="buttons/add_empty_item.tpl" but_onclick="Tygh.$('#item-{$smarty.foreach.for_reserv.iteration}').cloneNode(1,true);" item_id="{$smarty.foreach.for_reserv.iteration + 1}"}
